...
def order_email(name, order, subject, sender, recipients):
    ...
    Your order has been completed and you will be receiving it shortly. <br> Here is what you have ordered: " + <b> str(order)</b>
    mail.send(msg)
...
def reg_email(user):
    ...
    msg.html = "<b> Username: </b>" + user.username + "<br>" + "<b> User Type: </b>" + user.user_type + "<br>" + \
    +   "<b> User Email Address: </b>" + user.email_address + \
    +    "<a href="https://nnhshalfcaf.com">Half-Caf App</a>" 
    mail.send(msg)